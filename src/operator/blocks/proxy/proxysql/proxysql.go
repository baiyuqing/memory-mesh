// Package proxysql implements the proxy.proxysql block, deploying a
// ProxySQL connection pooler in front of a MySQL engine block.
package proxysql
